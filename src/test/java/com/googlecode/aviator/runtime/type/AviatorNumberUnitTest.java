...
public class AviatorNumberUnitTest {
	...
	public void testAddWithJavaString() {
		AviatorNumber a = AviatorNumber.valueOf(1000);
		AviatorJavaType s = new AviatorJavaType("s");
		assertEquals("1000hello", a.add(s, createEnvWith("s", "hello"))
				.getValue(null));
		assertEquals("1000hello", a.add(s, createEnvWith("s", "hello"))
				.getValue(null));
		assertEquals(AviatorType.String, a.add(s, createEnvWith("s", "hello"))
				.getAviatorType());
	}
	...
	public void doArithOperationWithJavaType(OperatorType operatorType) {
		...
		case Mod:
			...
			a = AviatorNumber.valueOf(1000);
			assertEquals(2.4000,
					(Double) a.mod(doubleType, env).getValue(null), 0.001);
			a = AviatorNumber.valueOf(1000);
			assertEquals(2.4000, (Double) a.mod(floatType, env).getValue(null),
					0.001);
			break;
		case Mult:
			a = AviatorNumber.valueOf(1000);
			...
			a = AviatorNumber.valueOf(1000);
			assertEquals(4300.0, (Double) a.mult(doubleType, env)
					.getValue(null), 0.001);
			a = AviatorNumber.valueOf(1000);
			assertEquals(4300.0,
					(Double) a.mult(floatType, env).getValue(null), 0.001);
			break;
		case Div:
			a = AviatorNumber.valueOf(1000);
			...
			a = AviatorNumber.valueOf(1000);
			assertEquals(232.558139,
					(Double) a.div(doubleType, env).getValue(null), 0.001);
			a = AviatorNumber.valueOf(1000);
			assertEquals(232.558139,
					(Double) a.div(floatType, env).getValue(null), 0.001);
			break;
	...
	public void testArthOperationWithNumber(OperatorType operatorType) {
		...
		case Div:
			...
			reset();
			assertEquals(0.90909090, (Double) b.div(a, null).getValue(null),
					0.001);
			reset();
			assertEquals(0.76744, (Double) a.div(d, null).getValue(null), 0.001);
			reset();
			assertEquals(1.30303030, (Double) d.div(a, null).getValue(null),
					0.001);
			reset();
			...
			reset();
			assertEquals(0.6976744, (Double) b.div(d, null).getValue(null),
					0.001);
			reset();
			assertEquals(1.433333333, (Double) d.div(b, null).getValue(null),
					0.001);
			break;
		case Mod:
			reset();
	...
	private void reset() {
		a = AviatorNumber.valueOf(3.3f);
		b = AviatorNumber.valueOf(3);
		c = AviatorNumber.valueOf(1000);
		d = AviatorNumber.valueOf(4.3d);
	}
