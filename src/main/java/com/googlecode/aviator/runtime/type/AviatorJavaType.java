...
public class AviatorJavaType extends AviatorObject {
    ...
    @Override public Object getValue(Map<String, Object> env) {
        try {
            boolean enableProperty = AviatorEvaluator.getOption(Options.ENABLE_SYNTACTIC_SUGAR);
            if (env != null) {
                if (enableProperty && this.name.contains(".")) {
            ...
            case JavaType:
                ...
                if (thisValue.equals(otherValue)) {
                    ...
                    if (thisValue instanceof Number) {
                        ...
                        AviatorString thisAviatorString =
                            new AviatorString(String.valueOf(thisValue));
                        return thisAviatorString.compare(other, env);
                    } else if (thisValue instanceof Boolean) {
                        AviatorBoolean thisAviatorBoolean =
                            AviatorBoolean.valueOf((Boolean) thisValue);
                        ...
                        try {
                            ...
                            throw new ExpressionRuntimeException(
                                "Compare " + this + " with " + other + " error", t);
                        }
                    }
                }
            case Nil:
