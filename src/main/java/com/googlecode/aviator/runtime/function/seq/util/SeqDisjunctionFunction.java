 ...
 * @author bluecrush
 */
public class SeqDisjunctionFunction extends AbstractFunction {
    @Override
    ...
    public AviatorObject call(Map<String, Object> env, AviatorObject arg1, AviatorObject arg2) {
        ...
        while (iterator.hasNext()) {
            ...
            for (int i = 0, m = ((Math.max(SeqUtil.getFreq(obj, map1), SeqUtil.getFreq(obj, map2))) - (Math.min(SeqUtil.getFreq(obj, map1), SeqUtil.getFreq(obj, map2)))); i < m; i++) {
                list.add(obj);
            }
        }
